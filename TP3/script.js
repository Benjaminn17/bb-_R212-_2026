// Exercice 1 — Données → affichage, Les données
const projets = [
...
//Exercice 2 — Filtrage interactif
...
function remove() {
    localStorage.removeItem('projets', JSON.stringify(projets));
